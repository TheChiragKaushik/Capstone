...
import TrackerCalender from "../PatientCalender/TrackerCalender";
...
const PrescriptionTable: React.FC<PrescriptionTableProps> = ({ user }) => {
  ...
  const [trackerExpandedId, setTrackerExpandedId] = useState<
    string | number | null
  >(null);
  ...
  const handleTrackerAccordionToggle = (id: string) => {
    setTrackerExpandedId(trackerExpandedId === id ? null : id);
  };
        ...
        <Table>
          <TableHead sx={{ backgroundColor: "#F9FAFB" }}>
            ...
            >
              ...
              <TableCell align="center">Medication Tracking</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {user?.prescriptions
